...
for pop in `ls ${outputFolder}/pop_fTwo/*.txt`; 
	...
	/commun/data/packages/vcftools/vcftools_0.1.12b/bin/vcftools --vcf ${inputFolder}/fTwo/$tag1.$tag2.mac2G.noDouble.recode.vcf --keep $pop --recode --stdout | /commun/data/packages/vcftools/vcftools_0.1.12b/bin/vcftools --vcf - --extract-FORMAT-info GT --out ${outputFolder}/fTwo/$tag1.$tag2.mac2G.noDouble.$tmpTag
done
